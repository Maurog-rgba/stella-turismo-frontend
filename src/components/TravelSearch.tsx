...
export function TravelSearch({ onSearch }: TravelSearchProps) {
  ...
  return (
    <div className="bg-white rounded-md shadow-lg p-6 md:p-8 max-w-6xl mx-auto relative z-10 border border-gray-100">
      <div className="flex flex-row gap-3 md:gap-6 w-full items-center">
        {/* Destino */}
        ...
        {/* Datas */}
        <div className="flex flex-row items-stretch bg-white rounded-md border border-gray-300 overflow-hidden divide-x divide-gray-300">
          {/* Data de Início */}
          <Popover>
        ...
        {/* Botão */}
        <div className="flex items-end w-1/2 min-w-[120px] max-w-[180px]">
          <Button
            onClick={handleSearch}
            size="lg"
            className="bg-[var(--primary)] text-white rounded-md px-8 h-12 w-full shadow-lg transition-all duration-200"
